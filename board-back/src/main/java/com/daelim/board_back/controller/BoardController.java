package com.daelim.board_back.controller;
...
public class BoardController {
    ...
    public ResponseEntity<? super IncreaseViewCountResoponseDto> increaseViewCount(
        @PathVariable("boardNumber") Integer boardNumber
    ) {
        ResponseEntity<? super IncreaseViewCountResoponseDto> response = boardService.increaseViewCount(boardNumber);
        return response;
    }
    ...
    public ResponseEntity<? super PutFavoriteResponseDto> putFavorite(
        @PathVariable("boardNumber") Integer boardNmber,
        @AuthenticationPrincipal String email
    ) {
        ResponseEntity<? super PutFavoriteResponseDto> response = boardService.putFavorite(boardNmber, email);
        return response;
    }
