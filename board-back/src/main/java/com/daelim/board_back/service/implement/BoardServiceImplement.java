...
import com.daelim.board_back.repository.ImageRepository;
...
public class BoardServiceImplement implements BoardService {
    ...
    @Override
    public ResponseEntity<? super IncreaseViewCountResoponseDto> increaseViewCount(Integer boardNumber) {
        
        try {
            BoardEntity boardEntity = boardRepository.findByBoardNumber(boardNumber);
            if(boardEntity == null) return IncreaseViewCountResoponseDto.noExistBoard();
        ...
        return IncreaseViewCountResoponseDto.success();
    }
